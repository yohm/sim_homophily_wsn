...
int main( int argc, char** argv) {
  ...
  if( argc != 11 ) {
    std::cerr << "q is different for each feature. Ranging [q_min, qmin+F-1]" << std::endl;
    std::cerr << "Usage : ./main.out <N> <p_tri> <p_jump> <p_ld> <aging> <w_th> <F> <q_min> <t_max> <seed>" << std::endl;
